  ...
  return (
    <div className="flex relative min-h-screen h-screen bg-gradient-to-r from-[#FAF0F0] to-white">
      ...
      <div className="flex-1 flex flex-col justify-between px-[7rem] py-[5rem] text-[#2a2a2a] h-screen">
        ...
        <div>
           <h1 className="text-3xl md:text-4xl leading-tight text-gray-900" style={{fontFamily: 'DM Serif Display, serif'}}>
  <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
    Don't let 
    <span className="text-[#fd526b] underline decoration-dotted decoration-[#fd526b] decoration-5 underline-offset-4">
      bad healthcare
    </span> 
    decide
  </div>
        ...
        <div className="fixed inset-0 bg-black/15 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-8 max-w-[40rem] w-full mx-4 relative">
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3" style={{fontFamily: 'DM Serif Display, serif'}}>
                Thank You!
              </h2>
